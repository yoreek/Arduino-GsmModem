...
#define _READY_TIMEOUT        15000 // ms, wait for command ready
#define _READY_PATTERN        "+PBREADY"
...
class M590: public GsmModem {
    public:
        M590(Stream     *port,
             size_t      bufSize,
             uint8_t     powerSwitchPin,
             const char *simPin = "") :
             GsmModem(port, bufSize, powerSwitchPin, LOW, simPin)
        {
